...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    private var _noteAddUpdateBinding: ActivityNoteAddUpdateBinding? = null
    private val binding get() = _noteAddUpdateBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        _noteAddUpdateBinding = ActivityNoteAddUpdateBinding.inflate(layoutInflater)
